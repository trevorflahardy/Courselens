  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col glass-strong">
      ...
      <div className="flex h-16 items-center gap-3 px-6 border-b border-glass-border">
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary/20 liquid-glow">
        ...
        <div>
          <h1 className="text-sm font-semibold tracking-tight">Course Audit</h1>
          <p className="text-xs text-muted-foreground">EGN 3000L</p>
        </div>
      </div>
          ...
          return (
            <Link
              ...
              className={`
                ...
                ${isActive
                  ? "glass-strong text-primary liquid-glow"
      ...
      <div className="border-t border-glass-border px-6 py-4">
        <div className="flex items-center gap-2">
          <div className="h-2 w-2 rounded-full bg-severity-ok animate-pulse" />
